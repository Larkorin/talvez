import { c as create_ssr_component, e as escape, a as validate_store, b as subscribe, f as each, d as add_attribute, v as validate_component, n as null_to_empty } from "../../../chunks/ssr.js";
...
const TodoItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="todo s-Q8a94wiD58C4"><p>${escape(index + 1)}. ${escape(todo)}</p> <div class="actions s-Q8a94wiD58C4"><i class="fa-regular fa-pen-to-square s-Q8a94wiD58C4"></i> <i class="fa-regular fa-trash-can s-Q8a94wiD58C4"></i></div> </div>`;
});
