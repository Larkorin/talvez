import{w as zl}from"./index.92808898.js";const qv=typeof window<"u"?window:typeof globalThis<"u"?globalThis:global;/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fv=5*60,Vv=Ka("authIdTokenMaxAge")||Fv;let Va=null;const $v=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>Vv)return;const s=t==null?void 0:t.token;Va!==s&&(Va=s,await fetch(n,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Bv(n=pr()){const e=fr(n,"auth");if(e.isInitialized())return e.getImmediate();const t=hy(n,{popupRedirectResolver:Mv,persistence:[Hy,Py,xl]}),i=Ka("authTokenSyncURL");if(i){const r=$v(i);by(t,r,()=>r(t.currentUser)),ky(t,o=>r(o))}const s=za("auth");return s&&fy(t,`http://${s}`),t}Uv("Browser");const $a={apiKey:"AIzaSyDJ9fvmGRy59lavDDO8ulBrtqeaCejkWRM",authDomain:"posiblemente-9ec97.firebaseapp.com",projectId:"posiblemente-9ec97",storageBucket:"posiblemente-9ec97.appspot.com",messagingSenderId:"765586851595",appId:"1:765586851595:web:e5a7dfa910910f61cf040e"};let Et;ld().length&&(Et=pr(),hd(Et)),Et=Us($a);const Wv=wm(Et),Ns=Bv(Et),Gv=zl({user:null,loading:!0,data:{}}),Qv={signup:async(n,e)=>{await Cy(Ns,n,e)},login:async(n,e)=>{await Ay(Ns,n,e)},logout:async()=>{await Ry(Ns)}};export{Ns as a,Hv as b,Gv as c,Wv as d,qv as e,Qv as f,zv as g,Kv as m};
